...
class FollowersTVC: UITableViewController {
    ...
    deinit {
        print("noti followerstvc de init")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = UITableViewCell(style: UITableViewCell.CellStyle.subtitle, reuseIdentifier: "followerCell")
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        DispatchQueue.main.async {
            SwiftEntryKit.display(entry: uProfileViewer, using: atr)
        }
